...
//        @property (nonatomic, copy) NSString *userName;
        ...
        NSString *contentOfTopic = @"紧紧围绕坚持和发展中国特色社会主义　学习宣传贯彻党的十八大精神,";
        NSInteger count = arc4random()%3;
        for (int i = 0; i < count; i++) {
            contentOfTopic = [contentOfTopic stringByAppendingString:contentOfTopic];
        }
        ...
        [mDic setObject:[arrOfPicURL objectAtIndex:(arc4random()%[arrOfPicURL count])] forKey:@"headPicUrl"];
...
//        NSString *contentOfTopic = @"";
        ...
        [mDic setObject:[NSString stringWithFormat:@"新闻_%d",arc4random()%10000] forKey:@"title"];
